...
bool oled_task_user(void) {
    oled_set_cursor(0, 4);                            // sets cursor to (row, column) using charactar spacing (5 rows on 128x32 screen, anything more will overflow back to the top)
